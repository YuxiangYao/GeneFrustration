...
source("/mnt/yaoyuxiang/p01_rp/6_finalize/Auxiliary_Functions_for_Figure/aux_ggplot2Theme.R");
Rcpp::sourceCpp("/mnt/yaoyuxiang/p01_rp/6_finalize/cpp_Source/c_DoubleBinCountAv.cpp");# C++: DoubleBins(...)
